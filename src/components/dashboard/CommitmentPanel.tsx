...
export function CommitmentPanel() {
  ...
  const allRows = buildObjectiveRows();
        ...
        <CardContent className="pt-0">
          {loading ? (
            ...
            <div className="text-center py-6">
              <p className="text-sm text-muted-foreground mb-3">Nenhum objetivo definido para este mês.</p>
              <Button variant="outline" size="sm" onClick={() => setEditOpen(true)}>
                <Plus className="h-4 w-4 mr-1" /> Definir Objetivo
              </Button>
            </div>
          ) : (
            <Table>
