...
import { Lock, ChevronDown, ChevronRight, Trash2 } from 'lucide-react';
      ...
      {closing ? (
        <Card>
          <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <CardTitle className="text-base">Mês Fechado</CardTitle>
              <p className="text-sm text-muted-foreground">
                Fechado em {format(new Date(closing.closed_at), 'dd/MM/yyyy HH:mm')}
              </p>
            </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              As comissões deste mês ainda não foram calculadas. Clique em "Fechar Mês" para agregar o consumo e calcular as comissões finais por comercial.
            </p>
          </CardContent>
        </Card>
      )}
