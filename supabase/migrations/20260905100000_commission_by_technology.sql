-- ============================================================
-- Comissão por tecnologia (Fibra / Satélite)
-- ============================================================
-- A mesma oferta paga valores diferentes conforme seja instalada em fibra ou
-- em satélite — tanto o que a operadora paga à org como o que o vendedor
-- recebe. A tecnologia é escolhida na venda e fica congelada em
-- servicos_details[produto].tecnologia.
--
...
-- único e o resultado é bit a bit o mesmo de antes.
