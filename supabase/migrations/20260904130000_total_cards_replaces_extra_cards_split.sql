-- ============================================================
-- Cartões extra: o vendedor passa a indicar o total de cartões da
-- linha, não a quantidade extra diretamente
-- ============================================================
-- servicos_details[produto].total_cards agora é a fonte de verdade quando
-- presente: quantos cartões a linha tem ao todo. O que é "extra" é
-- total_cards menos o included_cards do produto (default 1). Sem
-- total_cards, mantém o comportamento antigo (extra_cards_portability +
-- extra_cards_new), para vendas antigas continuarem a calcular a mesma
-- comissão que já tinham.
