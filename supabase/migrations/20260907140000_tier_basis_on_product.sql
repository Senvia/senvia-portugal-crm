-- ============================================================
-- Base do escalão escolhida no produto
-- ============================================================
-- Substitui 20260907130000. O produto diz que quantidade escolhe o escalão:
-- a desta venda (tier_basis = per_sale) ou o acumulado do mês
-- (monthly_volume, da organização ou por vendedor via tier_scope). Sem o
-- campo vale o da operadora, como sempre — a Digi não muda.
