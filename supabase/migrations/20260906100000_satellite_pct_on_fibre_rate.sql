-- ============================================================
-- Satélite: a percentagem é sobre o valor de FIBRA da própria linha
-- ============================================================
-- Substitui 20260905120000. Uma comissão de satélite em % era lida como
-- percentagem do que a operadora paga, e isso pagava a mesma coisa a toda a
-- gente: 30% de 200€ = 60€, fosse a linha do vendedor de 170€ ou de 300€.
-- Resultado: a margem da organização em satélite dava sempre zero.
--
-- O satélite é uma fatia da fibra, por pessoa:
--   Vitor, 4 Nível 1 — fibra 170€  ->  satélite 170 x 30% = 51,00€
--   Operadora,        — fibra 200€  ->  satélite 200 x 30% = 60,00€
--   Organização fica com 60 - 51 = 9,00€
--
-- Em fibra a percentagem continua a ser sobre o que a operadora paga, e sem
-- operadora configurada cai no preço unitário, como antes.
