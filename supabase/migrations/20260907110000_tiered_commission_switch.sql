-- ============================================================
-- Interruptor "comissão por escalão" no produto
-- ============================================================
-- Substitui 20260906110000. O produto ganha tiered_commission (true/false):
-- ligado, os escalões contam; desligado, ficam guardados mas ignorados e
-- pagam as linhas fixas. Sem o campo (todos os produtos até hoje) vale a
-- regra antiga — há escalões, usam-se — portanto nada muda no que existe.
