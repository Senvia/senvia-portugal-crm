-- ============================================================
-- Interruptor do Bónus Geral em cada escalão
-- ============================================================
-- Substitui 20260907110000. Cada escalão ganha bonus_enabled: desligado, o
-- valor do bónus fica guardado mas não paga. Sem o campo (todos os escalões
-- até hoje) vale a regra antiga — bónus diferente de zero conta.
